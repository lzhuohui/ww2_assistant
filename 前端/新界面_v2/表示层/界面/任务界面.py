...
class TaskPage:
    ...
    def create(
        ...
        title_bar = ft.Row([
            ft.Icon(ft.Icons.ASSIGNMENT, size=20, color=theme_colors.get("accent")),
            ft.Container(width=6),
            ft.Text("任务设置", size=16, weight=ft.FontWeight.BOLD, color=theme_colors.get("text_primary")),
...
if __name__ == "__main__":
    ft.run(lambda page: page.add(TaskPage.create()))
