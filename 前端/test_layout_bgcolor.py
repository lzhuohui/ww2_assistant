...
if __name__ == "__main__":
    print("正在启动主布局bgcolor测试...")
    print("测试添加主布局bgcolor是否会导致白板问题")
    ft.run(main)