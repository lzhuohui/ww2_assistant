# -*- coding: utf-8 -*-
"""
模块名称：集资界面 | 设计思路：配置驱动架构，通过设置面板自动创建卡片 | 模块隔离原则：不直接创建被调用模块的内容，不覆盖被调用模块的计算结果，用户指定变量除外
"""
...
if __name__ == "__main__":
    ft.run(lambda page: page.add(FundraisingInterface.create()))
