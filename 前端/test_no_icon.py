...
说明：测试移除ft.Icon是否会导致白板问题
"""

import flet as ft


class SimpleNavBarNoIcon(ft.Container):
    """简单的导航栏类，移除ft.Icon"""
...
def main(page: ft.Page):
    ...
    # 导航栏 - 使用SimpleNavBarNoIcon类
    nav = SimpleNavBarNoIcon(on_nav_change)
