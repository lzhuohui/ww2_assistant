...
# -*- coding: utf-8 -*-
"""
测试继承自ft.Container的简单类

创建日期: 2026-03-08
作者: AI
版本: v1.0.0

说明：测试继承自ft.Container的简单类是否会导致白板问题
"""

import flet as ft


class SimpleNavBar(ft.Container):
    """简单的导航栏类，继承自ft.Container"""
    def __init__(self):
        super().__init__()
        self._build()
...
if __name__ == "__main__":
    print("正在启动简单类测试...")
    print("测试继承自ft.Container的简单类是否会导致白板问题")
    ft.run(main)