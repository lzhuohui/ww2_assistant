# -*- coding: utf-8 -*-
"""模块名称：打扫界面 | 设计思路：打扫配置界面，使用折叠卡片模式 | 模块隔离原则"""
...
if __name__ == "__main__":
    ...
    ft.run(lambda page: page.add(打扫界面.create(config=config, on_save=on_save)))
